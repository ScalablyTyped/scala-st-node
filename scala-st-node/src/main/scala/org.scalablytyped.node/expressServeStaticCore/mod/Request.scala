...
import org.scalablytyped.node.expressServeStaticCore.expressServeStaticCoreBooleans.`false`
import org.scalablytyped.node.expressServeStaticCore.expressServeStaticCoreStrings.`set-cookie`
...
import org.scalablytyped.node.rangeParser.mod.Options
import org.scalablytyped.node.rangeParser.mod.Ranges
import org.scalablytyped.node.rangeParser.mod.Result
...
trait Request[P /* <: Params */, ResBody, ReqBody, ReqQuery]
  extends IncomingMessage
     with org.scalablytyped.node.expressServeStaticCore.mod.global.Express.Request {
  /**
