...
trait ServerOptions extends js.Object {
  var IncomingMessage: js.UndefOr[
    Instantiable1[/* socket */ Socket, org.scalablytyped.node.node.httpMod.IncomingMessage]
  ] = js.undefined
  var ServerResponse: js.UndefOr[
    Instantiable1[/* req */ IncomingMessage, org.scalablytyped.node.node.httpMod.ServerResponse]
  ] = js.undefined
  /**
