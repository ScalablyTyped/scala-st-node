...
import org.scalablytyped.node.node.nodeStrings.OCSPRequest
import org.scalablytyped.node.node.nodeStrings.keylog
import org.scalablytyped.node.node.nodeStrings.newSession
import org.scalablytyped.node.node.nodeStrings.resumeSession
import org.scalablytyped.node.node.nodeStrings.secureConnection
import org.scalablytyped.node.node.nodeStrings.tlsClientError
