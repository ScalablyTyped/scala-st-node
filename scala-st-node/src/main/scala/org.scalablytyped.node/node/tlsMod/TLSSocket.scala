...
import org.scalablytyped.node.node.anon.RejectUnauthorized
...
import org.scalablytyped.node.node.nodeStrings.OCSPResponse
import org.scalablytyped.node.node.nodeStrings.keylog
import org.scalablytyped.node.node.nodeStrings.secureConnect
