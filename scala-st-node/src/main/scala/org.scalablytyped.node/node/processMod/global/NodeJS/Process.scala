...
import org.scalablytyped.node.node.anon.Debug
import org.scalablytyped.node.node.anon.ReadStreamfd0
import org.scalablytyped.node.node.anon.SwallowErrors
import org.scalablytyped.node.node.anon.Targetdefaults
import org.scalablytyped.node.node.anon.WriteStreamfd1
import org.scalablytyped.node.node.anon.WriteStreamfd2
import org.scalablytyped.node.node.domainMod.global.NodeJS.Domain
...
import org.scalablytyped.node.node.nodeStrings.beforeExit
...
import org.scalablytyped.node.node.nodeStrings.multipleResolves
import org.scalablytyped.node.node.nodeStrings.newListener
import org.scalablytyped.node.node.nodeStrings.rejectionHandled
import org.scalablytyped.node.node.nodeStrings.removeListener
import org.scalablytyped.node.node.nodeStrings.uncaughtException
import org.scalablytyped.node.node.nodeStrings.uncaughtExceptionMonitor
import org.scalablytyped.node.node.nodeStrings.unhandledRejection
import org.scalablytyped.node.node.nodeStrings.warning
...
trait Process extends EventEmitter {
  /**
    ...
    */
  var allowedNodeEnvironmentFlags: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ReadonlySet<string> */ js.Any = js.native
