...
import org.scalablytyped.node.node.httpMod.ClientRequestArgs
import org.scalablytyped.node.node.httpMod.OutgoingHttpHeaders
import org.scalablytyped.node.node.netMod.Socket
import org.scalablytyped.node.node.tlsMod.KeyObject
import org.scalablytyped.node.node.tlsMod.PxfObject
...
trait RequestOptions extends js.Object {
  var _defaultAgent: js.UndefOr[org.scalablytyped.node.node.httpMod.Agent] = js.undefined
  var agent: js.UndefOr[org.scalablytyped.node.node.httpMod.Agent | Boolean] = js.undefined
...
object RequestOptions {
  ...
  implicit class RequestOptionsOps[Self <: RequestOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_defaultAgent(value: org.scalablytyped.node.node.httpMod.Agent): Self = this.set("_defaultAgent", value.asInstanceOf[js.Any])
    @scala.inline
    def delete_defaultAgent: Self = this.set("_defaultAgent", js.undefined)
    @scala.inline
    def setAgent(value: org.scalablytyped.node.node.httpMod.Agent | Boolean): Self = this.set("agent", value.asInstanceOf[js.Any])
    @scala.inline
