...
- `org.scalablytyped.node`.node.httpMod.AgentOptions because var conflicts: timeout. Inlined keepAlive, keepAliveMsecs, maxSockets, maxFreeSockets */ trait AgentOptions extends ConnectionOptions {
  /**
