...
import org.scalablytyped.node.node.nodeStrings.altsvc
import org.scalablytyped.node.node.nodeStrings.origin
...
trait ClientHttp2Session extends Http2Session {
  ...
  def addListener_connect(
    event: org.scalablytyped.node.node.nodeStrings.connect,
