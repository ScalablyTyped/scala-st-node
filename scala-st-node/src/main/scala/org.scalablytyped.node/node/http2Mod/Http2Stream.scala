...
import org.scalablytyped.node.node.httpMod.OutgoingHttpHeaders
import org.scalablytyped.node.node.nodeStrings.data
import org.scalablytyped.node.node.nodeStrings.frameError
import org.scalablytyped.node.node.nodeStrings.streamClosed
import org.scalablytyped.node.node.nodeStrings.timeout
import org.scalablytyped.node.node.nodeStrings.trailers
import org.scalablytyped.node.node.nodeStrings.wantTrailers
...
trait Http2Stream extends Duplex {
  ...
  @JSName("addListener")
  def addListener_aborted(event: org.scalablytyped.node.node.nodeStrings.aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_aborted(event: org.scalablytyped.node.node.nodeStrings.aborted): Boolean = js.native
  @JSName("emit")
  ...
  @JSName("on")
  def on_aborted(event: org.scalablytyped.node.node.nodeStrings.aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("on")
  ...
  @JSName("once")
  def once_aborted(event: org.scalablytyped.node.node.nodeStrings.aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("once")
  ...
  def prependListener_aborted(event: org.scalablytyped.node.node.nodeStrings.aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("prependListener")
  ...
  def prependOnceListener_aborted(event: org.scalablytyped.node.node.nodeStrings.aborted, listener: js.Function0[Unit]): this.type = js.native
  @JSName("prependOnceListener")
