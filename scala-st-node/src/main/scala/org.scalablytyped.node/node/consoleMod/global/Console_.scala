package org.scalablytyped.node.node.consoleMod.global

import org.scalablytyped.node.node.consoleMod.global.NodeJS.ConsoleConstructor
import org.scalablytyped.node.node.utilMod.InspectOptions
